              ...
              <div className='lg:w-1/2'>
                ...
                <div className='pt-4 flex justify-end'>
                  ...
                  >
                    ...
                    {/* <button className='flex gap-2 px-5 py-3 text-white bg-brandRed-900 duration-150 hover:-translate-x-0 hover:duration-300 hover:scale-110 hover:transition-all hover:text-white rounded-full'>
                        Eu posso te ajudar
                        <svg
                          xmlns='http://www.w3.org/2000/svg'
                          width='24'
